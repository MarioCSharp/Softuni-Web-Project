...
namespace Better_Shkolo.Data.Migrations
{
    ...
    [Migration("20230522063949_absencesUpdate")]
            ...
            modelBuilder.Entity("Better_Shkolo.Data.Models.Parent", b =>
                {
                    ...
                    b.HasOne("Better_Shkolo.Data.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("Better_Shkolo.Data.Models.Parent", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Better_Shkolo.Data.Models.Student", b =>
                {
                    ...
                    b.HasOne("Better_Shkolo.Data.Models.Teacher", null)
                        .WithMany("Students")
                        .HasForeignKey("TeacherId");

                    b.HasOne("Better_Shkolo.Data.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("Better_Shkolo.Data.Models.Student", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Better_Shkolo.Data.Models.Teacher", b =>
                {
                    ...
                    b.HasOne("Better_Shkolo.Data.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("Better_Shkolo.Data.Models.Teacher", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
