        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExcusedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Absencess", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GradeName = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    GradeSpecialty = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    TeacherId = table.Column<int>(type: "int", nullable: false),
                    SchoolId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradeTeacherId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Absencess_SchoolId",
                table: "Absencess",
                column: "SchoolId");

            migrationBuilder.CreateIndex(
                name: "IX_Absencess_StudentId",
                table: "Absencess",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Absencess_SubjectId",
                table: "Absencess",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Absencess_TeacherId",
                table: "Absencess",
                column: "TeacherId");
